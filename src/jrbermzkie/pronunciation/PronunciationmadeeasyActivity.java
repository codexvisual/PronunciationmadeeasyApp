package jrbermzkie.pronunciation;
...
public class PronunciationmadeeasyActivity extends Activity {
	...
	private void addButtonListener() {
		...
		public void onClick(View v) {
			...
			Intent e = new Intent("jrbermzkie.pronunciation.SPEECH");
			startActivity(e);
		...
		btnAboutUs = (ImageButton) findViewById (R.id.AboutUs);
		btnAboutUs.setOnClickListener(new OnClickListener() {

			public void onClick(View v) {
				// TODO Auto-generated method stub
				
				Intent e = new Intent("jrbermzkie.pronunciation.CONTENT");
				startActivity(e);
		...
		btnListWord.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						Intent e = new Intent("jrbermzkie.pronunciation.WORD");
						startActivity(e);
		...
		bTnTutorial.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						Intent e = new Intent("jrbermzkie.pronunciation.LIST");
						startActivity(e);
